...
> Since 7.0.0 the packages are versioned independently. The JavaScript packages
> (`@wearerequired/eslint-config`, `@wearerequired/stylelint-config`) keep their
> own changelogs generated by [Changesets](https://github.com/changesets/changesets)
> in `packages/*/CHANGELOG.md`. This file now tracks the PHP package
